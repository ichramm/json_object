...
##
CPPFLAGS.base :=
CFLAGS.base := -Wall -Wextra -Wconversion -Wno-long-long -Wunused -funwind-tables -I$(INCDIR.libs) -I$(INCDIR.base) -I$(GENDIR.base)
CXXFLAGS.base := -Wall -Wextra -Wconversion -Wno-long-long -Wnon-virtual-dtor -Wunused -funwind-tables -I$(INCDIR.libs) -I$(INCDIR.base) -I$(GENDIR.base)
LDFLAGS.base := -L$(LIBDIR.libs) -L$(LIBDIR.base)
