...
# Register the Test
##
EXAMPLE.TGTS := $(EXAMPLE.TGTS) $(RDIR)/$(TGT)
...
$(eval $(call CMDS.EXAMPLE.TGT,$(RDIR),$(TGT),analysis))
...
$(eval $(call CMDS.EXAMPLE.TGT,$(RDIR),$(TGT),coverage))
...
$(eval $(call CMDS.EXAMPLE.TGT,$(RDIR),$(TGT),debug))
...
$(eval $(call CMDS.EXAMPLE.TGT,$(RDIR),$(TGT),profile))
...
$(eval $(call CMDS.EXAMPLE.TGT,$(RDIR),$(TGT),release))
